                    ...
                    <div class="form-horizontal">
                        <div class="form-group draggable">
                            ...
                            <label class="col-sm-2 control-label required">真实姓名:</label>
                             <div class="col-sm-4">
									<input id="username" value="${user.username}" type="text" class="form-control" placeholder="请输入用户真实姓名" name="username">
							</div>
                            <label class="col-sm-2 control-label required">登录名:</label>
                             <div class="col-sm-4">
									<input id="loginname" value="${user.loginname}" readonly type="text" class="form-control" placeholder="请输入登录名" name="loginname">
							</div>                          
                        </div>
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-4">
                                <input id="tell" name="tell" required value="${user.tell}" type="text" class="form-control" placeholder="请输入联系电话">
                            </div>
                        </div>	
 						<div class="form-group draggable">
                            <label class="col-sm-2 control-label">年龄:</label>
                            <div class="col-sm-4">
                               <input  id="age" name="age" type="number" value="${user.age}" class="form-control" placeholder="请输入年龄">
                            </div>
                            <label class="col-sm-2 control-label">出生日期:</label>
                            <div class="col-sm-4">
                                <input  id="birthday" name="birthday" value="${user.birthday}" class="laydate-icon form-control layer-date">
                            </div>
                        </div>	
                        <div class="form-group draggable">
                            <label class="col-sm-2 control-label">邮箱:</label>
                            <div class="col-sm-4">
									<input  id="email" name="email" value="${user.email}" type="email" class="form-control" placeholder="请输入邮箱名">
							</div>
                            <label class="col-sm-2 control-label">住址:</label>
                            <div class="col-sm-4">
									<input required id="address" name="address" value="${user.address}" type="text" class="form-control" placeholder="请输入居住地址">
							</div>
                        </div>
                        <div class="form-group draggable">
                            <label class="col-sm-2 control-label required">用户角色:</label>
                             <div class="col-sm-4">
								...
								<option value="${user.roles[0].roleid}">${user.roles[0].rolename}</option>
								</select>
							</div>
                        </div>
                    </div>
